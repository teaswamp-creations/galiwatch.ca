...
We continue to experiment with camera placement, and unfortunately this year was less optimal in that we were only able to identify the species of around 60% of visiting bumblebees. Nevertheless, we still have lots of data to play with.
...
4.  Pollinators: total number of sightings of bumblebees (699) was the highest we have seen since we started monitoring in 2021. However species diversity was lower with only two bumblebee species reliably observed in the camera traps, and very few observations of solitary bees.
...
5.  Bumblebees were seen within 12-24 hours of flowers opening. *B. flavifrons* predominated unlike previous years when *B. sitkensis* was the most prevalent, perhaps reflecting the proximity of nest sites.
...
-   Oregon grape is typically in flower for 3 weeks, but the time to 50% flowering is very variable ranging from 6 days (2024) to 20 days (2022).
